...
contract SignerTest1 is ERC721URIStorage {
    ...
    function verify(address signer, uint8 v, bytes32 r, bytes32 s, bytes32 hash) public pure returns (bool) {
    ...
    function executeSetIfSignatureMatch (
      ...
      bytes32 hashStruct = keccak256(
        abi.encode(keccak256("set(address sender,uint x,uint deadline)"),
          sender,
          x,
          deadline
        )
