...
contract SimplePaymentChannel {
    ...
    address payable public recipient; // The account receiving the payment
    ...
    function extend(uint256 newExpiraiton) external {
        require(msg.sender == sender);
        require(newExpiraiton > expiration);

        expiration = newExpiraiton;
    }
    ...
    // 'creating and verifying signatures' chapter.z
